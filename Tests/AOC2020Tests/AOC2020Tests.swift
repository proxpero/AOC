...
final class AOC2020Tests: XCTestCase {
    func testDay1() {
        ...
        XCTAssertEqual(day.p1(input), "793524")
        XCTAssertEqual(day.p2(input), "61515678")
    }
    ...
    func testDay3() {
        ...
        XCTAssertEqual(day.p1(input), "286")
        XCTAssertEqual(day.p2(input), "3638606400")
    }

    func testDay4() {
        let day = Year.days[4]!
        let input = Year.load(day: 4)
        XCTAssertEqual(day.p1(input), "206")
        XCTAssertEqual(day.p2(input), "123")
    }
