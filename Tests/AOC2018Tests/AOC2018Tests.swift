...
final class AOC2018Tests: XCTestCase {
    func testDay1() {
        ...
        XCTAssertEqual(day.p1(input), "402")
        XCTAssertEqual(day.p2(input), "481")
    }

    func testDay2() {
        let day = Year.days[2]!
        let input = Year.load(day: 2)
        XCTAssertEqual(day.p1(input), "6972")
        XCTAssertEqual(day.p2(input), "aixwcbzrmdvpsjfgllthdyoqe")
    }

    func testDay3() {
        let day = Year.days[3]!
        let input = Year.load(day: 3)
        XCTAssertEqual(day.p1(input), "119572")
        XCTAssertEqual(day.p2(input), "775")
    }
