...
>: Sequence {
    ...
    public struct Iterator: IteratorProtocol {
        ...
        internal init(
            ...
            self._baseStreamA = iteratorA
            self._baseStreamB = iteratorB
            self._baseStreamC = iteratorC
        }
